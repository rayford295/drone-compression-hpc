...
\vspace{0pt}
\begin{posterbox}[Existing Tiling QA Evidence]{green}
\centering
\includegraphics[width=\linewidth]{no_tiling_poster_panel.jpg}
\vspace{0.12in}
{\fontsize{20}{25}\selectfont
No-tiling reference panel from existing experiment outputs.}
\end{posterbox}
...
AI disclosure: OpenAI ChatGPT/Codex was used as a general writing assistant for portions of this poster text. No AI-generated figures, tables, experimental data, or scientific claims were used; the authors reviewed the content and remain responsible for it.}
