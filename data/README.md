...
scp -r /path/to/100_0005 USERNAME@dtai-login.delta.ncsa.illinois.edu:/projects/YOUR_PROJECT/data/
```

Or use rsync (faster for large files, resumable):
```bash
rsync -avP /path/to/100_0005 USERNAME@dtai-login.delta.ncsa.illinois.edu:/projects/YOUR_PROJECT/data/
```
